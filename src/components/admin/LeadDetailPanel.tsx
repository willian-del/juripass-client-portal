...
import { Phone, FileText, Eye, Trash2, Mail, MessageSquare } from 'lucide-react';
...
export function LeadDetailPanel({
  ...
  const mailtoUrl = `mailto:${lead.email}?subject=${encodeURIComponent(`Juripass — ${lead.company}`)}&body=${encodeURIComponent(`Olá ${lead.name},\n\n`)}`;
                    ...
                    <div key={s.id} className="flex items-center justify-between text-sm">
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        <div className="min-w-0">
                          <span className="font-medium block truncate">{material?.title || '—'}</span>
